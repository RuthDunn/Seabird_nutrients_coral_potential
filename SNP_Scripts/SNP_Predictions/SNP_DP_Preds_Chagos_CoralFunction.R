...
pred.data$logNitrogen <- log(pred.data$NitrogenInput.mid.nn)
...
coral.mveg <- as.data.frame(predict(coralgrowth.model.run.center, newdata = pred.data.gveg, allow_new_levels = TRUE))
fish.mveg <- as.data.frame(predict(fishbiomass.model.run.center, newdata = pred.data.gveg, allow_new_levels = TRUE))
graz.mveg <- as.data.frame(predict(grazing.model.run.center, newdata = pred.data.gveg, allow_new_levels = TRUE))
eros.mveg <- as.data.frame(predict(erosion.model.run.center, newdata = pred.data.gveg, allow_new_levels = TRUE))
...
pred.data$coralgrowth.mveg <- coral.mveg$Estimate
pred.data$coralgrowth.mveg.low <- coral.mveg$Q2.5
pred.data$coralgrowth.mveg.high <- coral.mveg$Q97.5
...
pred.data$fishbiomass.mveg <- fish.mveg$Estimate
pred.data$fishbiomass.mveg.low <- fish.mveg$Q2.5
pred.data$fishbiomass.mveg.high <- fish.mveg$Q97.5
...
pred.data$grazing.mveg <- graz.mveg$Estimate
pred.data$grazing.mveg.low <- graz.mveg$Q2.5
pred.data$grazing.mveg.high <- graz.mveg$Q97.5
...
pred.data$erosion.mveg <- eros.mveg$Estimate
pred.data$erosion.mveg.low <- eros.mveg$Q2.5
pred.data$erosion.mveg.high <- eros.mveg$Q97.5
